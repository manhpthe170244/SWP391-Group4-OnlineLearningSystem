<%-- 
    ...
    Created on : Jul 18, 2023, 10:19:03 AM
    Author     : admin
--%>
...
<html>
    ...
    <body>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <select class="dashBoardInput" name="sortTypePop" id="sortTypePop">
                        <option value="most">Package big to small</option>
                        <option value="least">Package small to big</option>
                    </select>
        ...
        <script>
            ...
            %>];
            var barColors = ["#FA8C51", "#EA98DA", "#6CE2D2"];
